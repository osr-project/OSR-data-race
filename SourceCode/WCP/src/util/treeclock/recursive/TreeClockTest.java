...
public class TreeClockTest {
	...
	public static TreeClockRecursive tc1() {
		...
		TreeClockRecursive tc = new TreeClockRecursive((short)1);
		tc.root = n1;
		tc.threadMap = threadMap;
		return tc;
	}
	
	public static TreeClockRecursive tc2() {
		HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> threadMap = 
				new HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> ();
	...
	public static void demo1() {
		TreeClockRecursive tc1 = tc1();
		TreeClockRecursive tc2 = tc2();
...
//		System.out.println(tc2_child.getHeadChild().getNext());
	...
	public static TreeClockRecursive tc3() {
		HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> threadMap = 
				new HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> ();
		...
		TreeClockRecursive tc = new TreeClockRecursive();
		tc.root = n1;
		tc.threadMap = threadMap;
		return tc;
	}
	
	public static TreeClockRecursive tc4() {
		HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> threadMap = 
				new HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> ();
	...
	public static void demo2() {
		TreeClockRecursive tc3 = tc3();
		TreeClockRecursive tc4 = tc4();
...
//		System.out.println(tc2_child.getHeadChild().getNext());
	...
	public static TreeClockRecursive tc5() {
		HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> threadMap = 
				new HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> ();
	...
	public static TreeClockRecursive tc6() {
		HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> threadMap = 
				new HashMap<Short, EfficientTreeNode<Triplet<Short, Integer, Integer>>> ();
	...
	public static void demo4() {
		TreeClockRecursive tc5 = tc5();
		TreeClockRecursive tc6 = tc6();
