...
import engine.racedetection.dc.treeclock.no_race_AL.DCEngine;

public class DCTreeClockNoRaceAL {

	public DCTreeClockNoRaceAL() {
	...
	public static void main(String[] args) {
		...
		DCEngine engine = new DCEngine(options.parserType, options.path,
