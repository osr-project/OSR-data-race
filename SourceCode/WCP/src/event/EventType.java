...
public enum EventType {
	ACQUIRE, RELEASE, READ, WRITE, FORK, JOIN, BEGIN, END, BRANCH, REQUEST, DUMMY;
	...
	public boolean isBranch(){
		return this.ordinal() == BRANCH.ordinal();
	}
	...
	public boolean isLockType() {
		return this.isAcquire() || this.isRelease() || this.isRequest();
	}
	...
	public String toString(){
		...
		if(this.isBranch()) str = "BRANCH";
		if(this.isRequest()) str = "REQUEST";
		return str;
	}
