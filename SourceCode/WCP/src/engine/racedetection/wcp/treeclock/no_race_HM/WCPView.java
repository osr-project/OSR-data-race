...
public class WCPView {
	...
	public static Function<TreeClock, Function<ClockEpochPair, Boolean>> compareEpochVC = tc -> clep -> clep
			.getAcquire().isLessThanOrEqual(tc);
	...
	public TreeClock getMaxLowerBound(Thread tReader, Lock l, TreeClock ct) {
		checkAndAddLock(l);
	...
	public void updateTopRelease(Lock l, TreeClock ht) {
		checkAndAddLock(l);
