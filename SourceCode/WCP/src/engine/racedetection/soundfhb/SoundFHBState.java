...
public class SoundFHBState extends State {
	...
	public SoundFHBState(HashSet<Thread> tSet, int verbosity) {
...
//	public void setLRLocId(Variable v, Thread t, int loc){
//		int vIndex = checkAndAddVariable(v);
//		int tIndex = threadToIndex.get(t);
//		this.lastReadVariableLocId.get(vIndex).set(tIndex, loc);
//		System.out.println("Updating last read loc for thread " + tIndex);
//	}
//	
//	public void setLREventClock(Variable v, Thread t, VectorClock VC){
//		int vIndex = checkAndAddVariable(v);
//		int tIndex = threadToIndex.get(t);
//		this.lastReadVariableClock.get(vIndex).get(tIndex).copyFrom(VC);
//		System.out.println("Updating last read VC for thread " + tIndex);
//	}
//	
//	public void setLREventId(Variable v, Thread t){
//		int vIndex = checkAndAddVariable(v);
//		int tIndex = threadToIndex.get(t);
//		this.eventId = this.eventId + 1;
//		this.lastReadVariableEventId.get(vIndex).set(tIndex, this.eventId);
//		System.out.println("Updating last read eId for thread " + tIndex);
//	}
