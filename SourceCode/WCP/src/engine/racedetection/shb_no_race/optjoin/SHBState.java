...
public class SHBState extends State {
	...
	// Join optimization
	public HashMap<Lock, Thread> lastThreadToRelease; // l -> last thread that released l
	public HashMap<Variable, Thread> lastThreadToWrite; // x -> last thread to write to x
