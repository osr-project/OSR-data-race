...
public class SoundSHBOfflineEngine extends RaceDetectionEngine<SoundSHBState, SooundSHBEvent> {

	private HashMap<String, HashSet<String>> variableToThreadSet;
	private HashMap<String, HashSet<String>> lockToThreadSet;


	public SoundSHBOfflineEngine(ParserType pType, String trace_folder, int verbosity) {
		super(pType);
