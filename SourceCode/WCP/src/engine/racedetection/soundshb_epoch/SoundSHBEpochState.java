...
public class SoundSHBEpochState extends State {
	...
	public SoundSHBEpochState(HashSet<Thread> tSet, int verbosity) {
...
//	private FullAdaptiveVC getFullAdaptiveVCFrom1DArray(ArrayList<FullAdaptiveVC> arr, int index) {
//		if (index < 0 || index >= arr.size()) {
//			throw new IllegalArgumentException("Illegal Out of Bound access");
//		}
//		return arr.get(index);
//	}
	...
	public boolean checkReadWriteRaceUsingFWALR(Variable v, VectorClock C_t, SemiAdaptiveVC R_v){
		int vIndex = checkAndAddVariable(v);
