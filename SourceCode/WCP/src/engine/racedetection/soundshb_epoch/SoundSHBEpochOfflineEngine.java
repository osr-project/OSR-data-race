...
public class SoundSHBEpochOfflineEngine extends RaceDetectionEngine<SoundSHBEpochState, SoundSHBEpochEvent> {

	private HashMap<String, HashSet<String>> variableToThreadSet;
	private HashMap<String, HashSet<String>> lockToThreadSet;


	public SoundSHBEpochOfflineEngine(ParserType pType, String trace_folder, int verbosity) {
		super(pType);
