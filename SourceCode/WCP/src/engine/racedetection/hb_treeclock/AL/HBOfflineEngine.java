package engine.racedetection.hb_treeclock.AL;
...
public class HBOfflineEngine extends RaceDetectionEngine<HBState, HBEvent> {
	...
	public HBOfflineEngine(ParserType pType, String trace_folder, boolean forceOrdering,
			boolean tickClockOnAccess, int verbosity) {
		super(pType);
		this.threadSet = new HashSet<Thread>();
		initializeReader(trace_folder);
		this.state = new HBState(this.threadSet, forceOrdering, tickClockOnAccess,
				verbosity);
