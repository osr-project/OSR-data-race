package engine.racedetection.dc.treeclock.no_race_HM;
...
public class DCAnnotationEngine extends Engine<Event> {
	...
	public DCAnnotationEngine(ParserType pType, String trace_folder) {
	...
	private void postAnalyzeTrace() {
		System.out.println(
				"Number of locations = " + Integer.toString(locationIdSet.size()));
		...
		System.out.println(
				"Number of variables = " + Integer.toString(variableFirst.size()));
		System.out.println("Number of variables (read) = "
				+ Integer.toString(readVariableFirst.size()));
		System.out.println("Number of variables (write) = "
				+ Integer.toString(writeVariableFirst.size()));
		System.out.println();
		...
		System.out.println(
				"Number of reads+writes = " + Integer.toString(readCount + writeCount));
		System.out
				.println("Number of acquire events = " + Integer.toString(acquireCount));
		System.out
				.println("Number of release events = " + Integer.toString(releaseCount));
	...
	private void setDifferenceMap(HashMap<String, Long> first, HashMap<String, Long> last,
			HashMap<String, Long> interval) {
