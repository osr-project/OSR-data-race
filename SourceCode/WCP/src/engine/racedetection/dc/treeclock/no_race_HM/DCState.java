...
public class DCState extends State {
	...
	public HashMap<Lock, HashMap<Long, HashMap<Long, TreeClock>>> lastReleaseLockReadVariable;
	...
	public void initData(HashSet<Thread> tSet) {
		...
		this.lastReleaseLockReadVariable = new HashMap<Lock, HashMap<Long, HashMap<Long, TreeClock>>>();
