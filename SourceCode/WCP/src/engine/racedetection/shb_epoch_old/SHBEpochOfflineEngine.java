...
public class SHBEpochOfflineEngine extends RaceDetectionEngine<SHBEpochState, SHBEpochEvent> {

	private HashMap<String, HashSet<String>> variableToThreadSet;
	private HashMap<String, HashSet<String>> lockToThreadSet;


	public SHBEpochOfflineEngine(ParserType pType, String trace_folder, int verbosity) {
		super(pType);
