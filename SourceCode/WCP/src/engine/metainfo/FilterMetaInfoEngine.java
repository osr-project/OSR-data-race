...
public class FilterMetaInfoEngine extends Engine<Event> {
	...
	public FilterMetaInfoEngine(ParserType pType, String trace_folder) {
	...
	private void processEvent(){
		...
		if(handlerEvent.getType().isBranch()){
