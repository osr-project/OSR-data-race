...
public class OrderedVarsEvent extends RaceDetectionEvent<OrderedVarsState> {
	...
	@Override
	public boolean Handle(OrderedVarsState state) {
	...
	@Override
	public void printRaceInfoLockType(OrderedVarsState state) {	
	}

	@Override
	public void printRaceInfoAccessType(OrderedVarsState state) {		
	}

	@Override
	public void printRaceInfoExtremeType(OrderedVarsState state) {		
	}

	@Override
	public boolean HandleSubAcquire(OrderedVarsState state) {
		return false;
	}

	@Override
	public boolean HandleSubRelease(OrderedVarsState state) {
		return false;
	}

	@Override
	public boolean HandleSubRead(OrderedVarsState state) {
		Variable v = this.getVariable();
...
//		System.out.println(C_t);
	...
	@Override
	public boolean HandleSubWrite(OrderedVarsState state) {
		Variable v = this.getVariable();
...
//		System.out.println(C_t);
	...
	@Override
	public boolean HandleSubFork(OrderedVarsState state) {
		Thread t = this.getThread();
	...
	@Override
	public boolean HandleSubJoin(OrderedVarsState state) {
		Thread t = this.getThread();
		Thread tc = this.getTarget();
		if (state.isThreadRelevant(tc)) {
			VectorClock C_t = state.getVectorClock(state.clockThread, t);
