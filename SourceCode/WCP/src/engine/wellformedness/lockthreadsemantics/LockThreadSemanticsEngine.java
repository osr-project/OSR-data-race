...
public class LockThreadSemanticsEngine extends WellFormednessEngine<LockThreadSemanticsState, LockThreadSemanticsEvent>{
		
	private HashMap<String, HashSet<String>> variableToThreadSet;
	private HashMap<String, HashSet<String>> lockToThreadSet;

	public LockThreadSemanticsEngine(ParserType pType, String trace_folder, int verbosity) {
		super(pType);
		this.threadSet = new HashSet<Thread> ();
		initializeReader(trace_folder);
		this.state = new LockThreadSemanticsState(this.threadSet, verbosity);
		handlerEvent = new LockThreadSemanticsEvent();
	...
	@Override
	protected boolean skipEvent(LockThreadSemanticsEvent handlerEvent){
		boolean skip = false;
	...
	@Override
	protected void postHandleEvent(LockThreadSemanticsEvent handlerEvent){
	}
