...
public abstract class WellFormednessEngine<St extends State, WNE extends WellFormednessEvent<St>> extends Engine<WNE> {
	...
	public WellFormednessEngine(ParserType pType) {
		super(pType);
	}
	...
	public boolean analyzeEvent(WNE handlerEvent, Long eventCount){
	...
	protected abstract boolean skipEvent(WNE handlerEvent);

	protected abstract void postHandleEvent(WNE handlerEvent);
