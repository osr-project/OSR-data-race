import engine.racedetectionengine.OSRPerVar.POBuild.POBuildReverse;
import engine.racedetectionengine.OSRPerVar.OSREngine;
import event.Event;
import event.Lock;
import event.Thread;
...
//        System.out.println("phase 1: " + trace_dir + ", time = " + (System.currentTimeMillis() - startTimeAnalysis) + " ms");
//        po.printArray();
        ...
        OSREngine engine = new OSREngine(ParserType.STD, trace_dir, numThreads, succFromNode, succToNode, startTimeAnalysis);
        succToNode = null;
        succFromNode = null;
...
//        System.out.println("Number of racy vars: " + engine.state.racyVars.size());
        System.out.println("Finished " + trace_dir + ",  time spend = " + String.format("%.1f", timeInMin) + " min,  "
                            + "racy vars found = " + engine.state.racyVars.size());
    }
