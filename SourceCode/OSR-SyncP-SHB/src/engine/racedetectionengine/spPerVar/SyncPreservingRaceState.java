...
public class SyncPreservingRaceState extends State {
	...
	public HashSet<Integer> racyVars = new HashSet<>();
	// == Internal data ==
	...
	public SyncPreservingRaceState(HashSet<Thread> tSet, String traceLocation, long startTime) {
	...
	public int checkAndAddVariable(Variable v){
		if(!variableToIndex.containsKey(v)){
			...
			if(this.stringVariableToThreadSet == null) {
				...
				threadsAccessingVar = this.variableToThreadSet.get(v);
