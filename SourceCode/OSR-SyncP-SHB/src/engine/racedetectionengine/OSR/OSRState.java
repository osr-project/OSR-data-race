...
public class OSRState extends State {
    ...
    public OSRState(Map<Integer, Map<Integer, ArrayList<Integer>>> succFromNode,
                    Map<Integer, Map<Integer, ArrayList<Integer>>> succToNode, int numThreads, int verbosity){
