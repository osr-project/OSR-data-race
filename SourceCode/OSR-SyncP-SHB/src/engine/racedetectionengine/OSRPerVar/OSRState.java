...
import engine.racedetectionengine.OSRPerVar.POBuild.PartialOrder;
...
public class OSRState extends State {
    ...
    public ArrayList<Boolean>[] inThreadIdToEventType; // thId -> list(isAcqO, lock set)
    ...
    // 6. SSP event set
    public VectorClock sspEventSet;
    ...
    public OSRState(int numThreads, Map<Integer, Map<Integer, ArrayList<Integer>>> succFromNode,
                    Map<Integer, Map<Integer, ArrayList<Integer>>> succToNode, long startTime, String traceDir, int verbosity){
        this.startTime = startTime;
        this.traceDir = traceDir;
        this.initInternalData(numThreads, succFromNode, succToNode);
    ...
    private void initData(int numThreads) {
        ...
        // part.6
        this.sspEventSet = new VectorClock(this.numThreads);
    }

    private void initInternalData(int numThreads, Map<Integer, Map<Integer, ArrayList<Integer>>> succFromNode,
                                  Map<Integer, Map<Integer, ArrayList<Integer>>> succToNode) {
        ...
        this.inThreadIdToEventType = (ArrayList<Boolean>[]) Array.newInstance(ArrayList.class, this.numThreads);
        for(int i=0;i<numThreads;i++){
            this.eventsVarsRead[i] = new HashMap<>();
            this.eventsVarsWrite[i] = new HashMap<>();
            this.inThreadIdToEventType[i] = new ArrayList<>();
        }
