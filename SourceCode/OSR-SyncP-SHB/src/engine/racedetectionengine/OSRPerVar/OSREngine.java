...
public class OSREngine extends RaceDetectionEngine<OSRState, OSREvent> {
    ...
    public OSREngine(ParserType pType, String trace_folder, int numThreads,
                     Map<Integer, Map<Integer, ArrayList<Integer>>> succFromNode,
                     Map<Integer, Map<Integer, ArrayList<Integer>>> succToNode, long startTime) {
        super(pType);
        stdParser = new ParseStandard(trace_folder, false);
        this.state = new OSRState(numThreads, succFromNode, succToNode, startTime, trace_folder, 0);
